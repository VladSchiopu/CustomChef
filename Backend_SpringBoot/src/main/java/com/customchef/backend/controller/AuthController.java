...
import com.customchef.backend.service.AuthService;
import com.customchef.backend.service.dto.LoginDto;
import com.customchef.backend.service.dto.LoginResponseDto;
import com.customchef.backend.service.dto.RegisterDto;
...
public class AuthController {
    ...
    public ResponseEntity<?> register(@RequestBody RegisterDto registerDto) {
        ...
        return new ResponseEntity<>(Map.of("message", "User registered"), HttpStatus.CREATED);
    }
